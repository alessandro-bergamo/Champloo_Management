...
public class PaymentMethodDAOTest {
    ...
    public static Collection objects() {
        return Arrays.asList(new Object[][] {
                {Type.INSERTPMETHOD, new PaymentMethodBean(402, "40824280482", "Visa", "Antonio Mancuso", 2, "", LocalDate.now()), true},
                {Type.INSERTPMETHOD, new PaymentMethodBean(402, "40824280482", "Visa", "Antonio Mancuso", 2, "", LocalDate.now()), false},
